...
#define CONFIG_M8_board 1

#define CONFIG_FT5X0X_MULTITOUCH  1
#define MAX_POINT                 10
#define FT5606_IIC_SPEED          100*1000    //400*1000
...
#else
#define SCREEN_MAX_X			1024// 2048//1024    
#define SCREEN_MAX_Y			768//1536//768    
#endif
...
//			printk("ft5606 multiple report event[%d]:x = %d,y = %d,id = %d,flag = %d,pressure = %d\n",i,event.x*2,event.y*2,event.id,event.flag,event.pressure);
			...
			input_report_abs(data->input_dev, ABS_MT_POSITION_X,  event.y/*1024 - event.x*/);
			input_report_abs(data->input_dev, ABS_MT_POSITION_Y,  event.x/*768 - event.y*/);
		}
