...
#define MAX_POINT  10//5//10//5

//#define CONFIG_TOUCHSCREEN_1024X768//cckaa add
#define CONFIG_TOUCHSCREEN_1024X600//cckaa add
...
static int ft5x0x_process_points(struct ft5x0x_data *data)
{
	...
	if (MAX_POINT == 5) {
		...
		ret = ft5x0x_rx_data(client, buf, 61);//13
	}
