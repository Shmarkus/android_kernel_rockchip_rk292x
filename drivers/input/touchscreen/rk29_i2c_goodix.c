...
static int goodix_config_ok(struct rk_ts_data *ts)
{
	...
	h = (rd_cfg_buf[3]<<8) + rd_cfg_buf[4];
       ...
       // printk("wwwwwwwwwwwwwwwwwwwwwww=%d\n",w);
       // printk("hhhhhhhhhhhhhhhhhhhhhhhhhhh=%d\n",h);
       // printk("nnnnnnnnnnnnnnnnnnnnnnnnnnnnnn=%d\n",n);

#if 1//def CONFIG_ARCH_RK29
...
#if (TS_MAX_X == 1024)&&(TS_MAX_Y == 600)			//for malata 10.1
	uint8_t config_info[] = {
		0x65,0x02,0x04,0x00,0x02,0x58,0x0A,0x32,0x1E,0xE7,0x32,0x02,0x08,0x10,0x4C,
		0x43,0x43,0x20,0x05,0x00,0x86,0x86,0x32,0x46,0x00,0x01,0x02,0x03,0x04,0x05,
		0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F,0x10,0x11,0x12,0x13,0x14,
		0x15,0x16,0x17,0x18,0x19,0x1A,0x1B,0x1C,0x1D,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x2B,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
};
#elif (TS_MAX_X == 1024)&&(TS_MAX_Y == 768)			//for malata 10.1
	uint8_t config_info[] = {
...
{
	printk("hrtimer_restart goodix_ts_timer_func------------------\n");
...
static int rk_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	{
		//printk("111111111111111111111111111111111111111111\n");
