...
int goodixx_init_platform_hw(void)
{
    if(gpio_request(TOUCH_RESET_PIN,NULL) != 0){
      gpio_free(TOUCH_RESET_PIN);
      printk("gt8xx_init_platform_hw gpio_request error\n");
      return -EIO;
    }
#if 0
...
struct goodix_platform_data goodix_info = {
	...
	.rest_pin = RK2928_PIN3_PC3,
  .init_platform_hw = goodixx_init_platform_hw,
};
#endif
...
#define TOUCH_RESET_PIN  RK2928_PIN3_PC3//RK30_PIN4_PD0
#define TOUCH_INT_PIN    RK2928_PIN3_PC7//RK30_PIN4_PC2
...
#if defined(CONFIG_TOUCHSCREEN_GT82X_IIC)		
{
	...
	.flags         = 0,				
	.irq           = TOUCH_INT_PIN,				
	.platform_data = &ts82x_pdata,//&ts82x_pdata,//&ts_pdata,		
	},
#endif
